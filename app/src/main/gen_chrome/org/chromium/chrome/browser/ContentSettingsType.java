...
public @interface ContentSettingsType {
   ...
   */
  int CONTENT_SETTINGS_TYPE_DESKTOP_VIEW = 40;
  /**
   * This content setting type is for play videos in background, when the browser is hidden or the
   * screen is turned off
   */
  int CONTENT_SETTINGS_TYPE_PLAY_VIDEO_IN_BACKGROUND = 41;
  /**
   * This content setting type is for play YouTube videos in browser instead of launch YouTube app,
   * even if link points to YouTube app
   */
  int CONTENT_SETTINGS_TYPE_PLAY_YT_VIDEO_IN_BROWSER = 42;
